...
public class PhotosLocidDateGetHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(PhotosLocidDateGetHandlerTest.class);
    ...
    @Test
    public void testPhotosLocidDateGetHandlerTest() throws ClientException {
        final CountDownLatch latch = new CountDownLatch(1);
        SimpleConnectionHolder.ConnectionToken connectionToken = null;
        final AtomicReference<ClientResponse> reference = new AtomicReference<>();
        String requestUri = "/api/v1/photos/43/43";
